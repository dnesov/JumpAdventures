...
public class LevelCompleteFloatStat : UIElement
{
    ...
    protected override void OnDisplay()
    {
        ...
        var labelAnimationTime = _tweenTime * 2f;

        _tween.TweenMethod(this, nameof(AnimateValueLabel), 0f, TargetValue, labelAnimationTime);
        _tween.Chain();
    ...
    private void AnimateValueLabel(float value)
    {
        _valueLabel.Text = string.Format(CultureInfo.InvariantCulture, Constants.TimerFormat, value);
